...
Page({
  data: {
    ...
    allBlock:[
      ...
      { name: '经验交流', pic: '../images/pic.jpg', pages: '../common/styleShow/styleShow', iconname: 'ketang'},
      { name: '跑步课堂', pic: '../images/pic.jpg', pages: '../common/classroom/classroom', iconname: 'yundong'},
      { name: '户外俱乐部', pic: '../images/pic.jpg', pages: '../common/styleShow/styleShow', iconname:'huwaixiuxi' },
